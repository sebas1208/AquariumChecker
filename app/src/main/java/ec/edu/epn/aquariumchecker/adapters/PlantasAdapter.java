...
public class PlantasAdapter<T> extends ArrayAdapter<T> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView lblNombre = (TextView) item.findViewById(R.id.peces_plantas_nombre);
        lblNombre.setText(datos.get(position).getNombre());

        TextView lblCantidad = (TextView) item.findViewById(R.id.plantas_peces_cantidad);
        lblCantidad.setText(String.format(getContext().getString(R.string.cantidad_peces_plantas),
                datos.get(position).getCantidad()));


        TextView lblDescripcion = (TextView) item.findViewById(R.id.plantas_peces_descripcion);
